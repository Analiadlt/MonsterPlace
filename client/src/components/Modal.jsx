...
export default function Modal1() {
  ...
  return (
    <div>
      <h3 className="carrito" onClick={handleOpen}>
        <span className="carrito-num">{carrito.length}</span>
        <ShoppingBasketIcon fontSize="5rem" />
      </h3>
                          ...
                          <div className="nick-junto">
                            <p className="precio-modal">
                              ...
                              <span
                                ...
                                onClick={() =>
                                  dispatch(removeCart(dragon.name))
                                }
                              >
