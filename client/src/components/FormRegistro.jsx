...
const Formulario = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: ({
      ...
      dispatch(
        addUser({ firstName, lastName, email, nickName, dateBirth, password })
      );
    },
  });
            ...
            <div className="user-box">
              ...
              {formik.touched.firstName && formik.errors.firstName ? (
                <div className="campoErr">
                  {" "}
                  <ErrorOutlineOutlinedIcon /> {formik.errors.firstName}
                </div>
              ) : null}
            </div>
