  ...
  return (
    <List
      ...
      sx={{
        ...
        borderRadius: "10px",
        boxShadow:
          "0 15px 40px 0 rgba(0, 0, 0, 0.904), 0 17px 17px 0 rgba(0, 0, 0, .5)",
        border: "none",
      }}
    >
      <div className="contendedor-encabezado">
        <ListItem>
          <ListItemButton>
            <h4 className="encabezado">User</h4>{" "}
          </ListItemButton>
          <ListItemButton>
            <h4 className="encabezado">Nick Name </h4>{" "}
          </ListItemButton>
        </ListItem>
      </div>
        ...
        return (
          <div className="casillero">
            <ListItem key={value} disablePadding>
              <ListItemButton>
                <ListItemAvatar>
                  <Avatar alt={`Avatar n°${value + 1}`} src={avatar} />
                </ListItemAvatar>
                <ListItemText>
                  <p className="user">
                    {" "}
